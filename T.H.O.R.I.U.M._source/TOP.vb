...
Public Class DEPEND
    ...
    Public Function Return_value(ByRef Argument As Vector) As Vector
        ...
        For i As Integer = 0 To UBound(Point)
            ...
            inverse_Based_L(i) = 1 / ((Based_L(Argument, Point(i).Argument)) ^ n + 1.0E-30)
...
Public Class MEDIUM1
    ...
    ' Предок. Описание свойств конечного элемента (например, PSHELL или PSOLID) с которым ассоциируется данная среда
    Public Parent As Object

    ' Материал предка. 
    Public Parental_material As Object
...
Public Class RSOURCE1
    ...
    ''' <summary>
    ''' The medium, there source is located
    ''' </summary>
    ''' <remarks></remarks>
    Public Emitter_Medium As MEDIUM1
    ...
    Public Function Calc_Q(ByRef Argument As Vector) As Double
        ...
        Else
            ...
            Return Q.Return_value(Argument).Coord(0)
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function Calc_Q() As Double
...
Public Class HSOURCE1
    ...
    ''' <returns>Quatinty of heat</returns>
    ''' <remarks></remarks>
    Public Function Heat() As Double
