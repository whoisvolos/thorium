...
Public Class Model
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Is_solution_constant As Boolean
...
Skip_face:
    ...
    ''' <remarks></remarks>
    Public Function Extract_Polygon_from_Face(ByRef Face() As Object) As Visualisation.Polygon()
        ...
        For i As Integer = 0 To UBound(Face)
            ...
            If UBound(Face(i).Grid) > 1 Then
                ...
                Polygon(i_Polygon).Text = Face(i).Text
            ...
            For i As Long = 0 To UBound(Whole_TOP_array) Step 1
                ...
                If Whole_TOP_array(i) = "I_PARAM" Then
                    ...
                    If i + 12 <= UBound(Whole_TOP_array) Then
                        ...
                        Smoothing_type = UCase(Trim(Whole_TOP_array(i + 11)))

                        N_steps = Val(Whole_TOP_array(i + 12))

                        If Not (Smoothing_type = "LINEAR" Or Smoothing_type = "CUBIC") Then
                    ...
                    'If InStr(Whole_TOP_array(i + 5), ".") > 0 Or InStr(Whole_TOP_array(i + 5).ToUpper, "E") > 0 Then

                    '    TOP_Epsilon = Val(Whole_TOP_array(i + 5))
            ...
            For j As Integer = 0 To UBound(MEDIUM(i).FTOP)
                ...
                For l As Integer = 0 To UBound(MEDIUM(i).n)
                    ...
                    If MEDIUM(i).lambda(l).GetType.ToString = "System.Int64" Then
                        ...
                        ' Даже если теплопроводность зависит от температуры,
                        ' термооптические коэффициенты не нужно пересчитывать 
                        'Is_solution_constant = False
                ...
                If MEDIUM(i).c.GetType.ToString = "System.Int64" Then
                    ...
                    ' Даже если теплоемкость зависит от температуры,
                    ' термооптические коэффициенты не нужно пересчитывать 
                    'Is_solution_constant = False
